...
type Meeting struct {
	...
	StartTime          tools.LocalTime `gorm:"type:date;not null;column:START_TIME"`
	EndTime            tools.LocalTime `gorm:"type:date;not null;column:END_TIME"`
	BookTime           tools.LocalTime `gorm:"type:date;not null;column:BOOK_TIME"`
