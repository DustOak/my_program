                    ...
                    <div class="card">
                        <div class="alert alert-info" role="alert"
                            ...
                            <s:if test="#reply.getSid().getId()==getStudent().getId() ">
                                <a href="/deleteReply?sessionId=<s:property value=" getSessionId()"/>&reply=<s:property value="#reply.getId()"/>&&post=<s:property  value="getPost()"/>" id="back-to-top" onclick="backTop()"> 删除</a>
                                ●
                            </s:if>
                            <s:if test="getAdmin()!=null">
                                <a href="/deleteReply?sessionId=<s:property value=" getSessionId()"/>&reply=<s:property value="#reply.getId()"/>&&post=<s:property  value="getPost()"/>"
